...
public class TestA {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            catLinkedList.add(0, new Cat("CatStart" + (i+1)));
            catLinkedList.add(catLinkedList.size(), new Cat("CatEnd" + (i+1)));
        }
        ...
        System.out.println(catLinkedList.get(catLinkedList.size() - 1 ));
