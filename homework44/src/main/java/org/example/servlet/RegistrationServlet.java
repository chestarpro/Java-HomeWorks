...
public class RegistrationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        UserModel userModel = new UserModel(req.getParameter("login"), req.getParameter("email"),
                req.getParameter("gender"), req.getParameter("password"));
        ...
        || userModel.getGender() == null || userModel.getGender().isEmpty()) {
            ...
            if(userDbLogin == null && userDbEmail == null){
                ...
                if (userModel.getId() != null) {
                    req.setAttribute("result", userModel);
